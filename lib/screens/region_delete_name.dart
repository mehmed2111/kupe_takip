            ...
            children: [
              ...
              Container(
                ...
                child: DropdownButton(
                  ...
                  icon:
                      Icon(Icons.arrow_drop_down, color: kLoginDarkBackground),
                  isExpanded: true,
                  iconSize: 30.0,
                              ...
                              for (region in _regionList) {
                                if (loggedUserID == region.userId) {
                                  if (region.id == _selectedRegion.id) {
                                    showDialog(
                                      context: context,
                                      builder: (_) => AgreeOrNotButton(
                                        dialogTitle: 'Bölgeyi Sil',
                                        dialogContent:
                                            'Seçilen bölgeyi silmek istediğinizden emin misiniz?',
                                        agreeBtnTitle: 'Evet',
                                        ...
                                        agreeOnPressed: () {
                                          ...
                                          setState(() {
                                            //print('selected Region Id: ${_selectedRegion.id}');
                                            _deleteRegionName(
                                                _selectedRegion.id);
                                            showDialog(
